...
namespace UsefulCode.SOArchitecture.Editor.CodeGeneration
{
    public static class SO_CodeGenerator
    {
        ...
        public static string DefaultPath => dataPath.Remove(dataPath.Length - 6) + "Packages/UsefulCode/Runtime/Data";
        ...
        private static void CreateTargetDirectories()
        {
            ...
            {
                DefaultPath + "/References",
                DefaultPath + "/RuntimeSets",
                DefaultPath + "/Variables",
            };
        }
