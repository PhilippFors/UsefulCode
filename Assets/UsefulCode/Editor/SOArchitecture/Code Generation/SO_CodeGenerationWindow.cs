...
namespace UsefulCode.SOArchitecture.Editor.CodeGeneration
{
    public class SO_CodeGenerationWindow : EditorWindow
    {
        ...
        private void DataFields()
        {
            ...
            _typeName = EditorGUILayout.TextField(
                new GUIContent("Type Name", "Case sensitive, ensure exact match with actual type name"), _typeName);
            ...
            _namespace = EditorGUILayout.TextField(
                new GUIContent("Namespace", "Case sensitive, ensure exact match with actual namespace"), _namespace);
